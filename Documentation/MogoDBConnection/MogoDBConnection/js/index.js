...
myapp.controller('MongoRestController',function($scope,$http) {
    ...
    $scope.getVideos = function () {
        var response = $http.get("https://www.googleapis.com/youtube/v3/search?part=snippet&maxResults=05&q=" + $scope.searchSting + "&type=video&key=UC_x5XG1OV2P6uZZ5FSM9Ttw");
